...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ArtikelRegulations>
 */
class ArtikelRegulationsFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'artikel_regulator' => fake()->company() . ' Regulator',
            'artikel_reference' => 'REG-' . fake()->randomNumber(4) . '/' . fake()->year(),
            'artikel_deskripsi_isi' => fake()->paragraphs(3, true),
            ...
            'penulis_id' => 1,
            'kategori_id' => 4, // Regulation category
