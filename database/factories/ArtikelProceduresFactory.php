...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ArtikelProcedures>
 */
class ArtikelProceduresFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'artikel_audit_objectives' => fake()->paragraph(3),
            ...
            'penulis_id' => 1,
            'kategori_id' => 3, // Procedures category
