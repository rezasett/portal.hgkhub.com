...
return new class extends Migration
{
    ...
    {
        Schema::create('artikel_findings', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('artikel_kondisi');
            $table->longText('artikel_kriteria');
            $table->longText('artikel_impact');
            $table->longText('artikel_rekomendasi');
    ...
    {
        Schema::dropIfExists('artikel_findings');
    }
};
