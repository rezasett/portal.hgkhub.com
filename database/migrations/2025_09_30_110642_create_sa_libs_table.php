...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //blm bener
        Schema::create('sa_libs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('std_profesi_id')->nullable()->constrained('glosarium_standar_profesis')->onDelete('set null');
